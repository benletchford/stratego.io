...
class GameTest(unittest.TestCase):
    ...
    def test_get_cells_between_inclusive(self):
        self.assertEqual(
            models.Game.get_cells_between_inclusive({'x': 0, 'y': 0}, {'x': 0, 'y': 5}),
            [{'y': 0, 'x': 0}, {'y': 1, 'x': 0}, {'y': 2, 'x': 0}, {'y': 3, 'x': 0}, {'y': 4, 'x': 0}, {'y': 5, 'x': 0}]
        )

        self.assertEqual(
            models.Game.get_cells_between_inclusive({'x': 0, 'y': 5}, {'x': 0, 'y': 0}),
            [{'y': 0, 'x': 0}, {'y': 1, 'x': 0}, {'y': 2, 'x': 0}, {'y': 3, 'x': 0}, {'y': 4, 'x': 0}, {'y': 5, 'x': 0}]
        )

        self.assertEqual(
            models.Game.get_cells_between_inclusive({'x': 0, 'y': 0}, {'x': 5, 'y': 0}),
            [{'y': 0, 'x': 0}, {'y': 0, 'x': 1}, {'y': 0, 'x': 2}, {'y': 0, 'x': 3}, {'y': 0, 'x': 4}, {'y': 0, 'x': 5}]
        )

        self.assertEqual(
            models.Game.get_cells_between_inclusive({'x': 5, 'y': 0}, {'x': 0, 'y': 0}),
            [{'y': 0, 'x': 0}, {'y': 0, 'x': 1}, {'y': 0, 'x': 2}, {'y': 0, 'x': 3}, {'y': 0, 'x': 4}, {'y': 0, 'x': 5}]
        )
